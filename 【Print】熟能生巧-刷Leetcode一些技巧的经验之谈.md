...
**如果你是一个人才，经过几轮的充分博弈，一定会把你送到合适的位置**。扫地僧之所以是扫地僧，是因为他有跳出博弈的能力，主动降到低自己好几个维度的地方狗着。如果他愿意，以他的能力手段和眼界，不出一阵子迅速就能进入武林界的top圈子。
...
看了这个图，一开始觉得很搞笑，后来猛然记起来自己昨晚在辅导娃的时候其实很有问题，翻开昨晚的视频，时间大概是21:41--21:43之间，安娜对一道题目提出异议，说不用提取公因式，直接计算不也可以吗？

我一下子就表示反对，而不是先认可再引导，我说那在计算 $$1999x2001$$ 的时候干嘛不直接计算呢？ 为什么还要化成$$（2000+1）* （2000-1）$$的形式呢？然后就是用一连串带有嘲讽的口音模仿安娜说话的样子。。。。安娜很无奈的捂住自己的耳朵。

其实孩子能提出自己的疑问，这个才是最最最关键的，否则只能是填鸭式的灌输知识，而不能知道安娜心里在想什么，然后有针对性的对这些思维进行解答和破除。 现在一个非常珍(zhen)贵的机会出现在我面前，我不仅视而不见，不能见到，甚至对安娜的心情和脸面进行了一番嘲讽！！！

现在我写这篇记录的时候内心是有点难过的。人们常说一个人的思维和眼界决定了他和他孩子能走多远，指的不就是我这种情况吗？父亲习惯性的嘲讽和打击，不正是孩子畏缩的根源吗？

那么嘲讽和打击是为了什么呢？ 是为了彰显自己很厉害吗？我看不是，父亲是什么样子的人，女儿心里是看的一清二楚，没必要装。所以这里我要感谢一本书《真希望我父母读过这本书 ([英]菲利帕·佩里 [[英]菲利帕·佩里])》。我觉得这是从小刻入在我内心的一种模式，如果没有意识到，且不断的每日反省，是很难得到纠正，且自己的下一代也很难摆脱这种行为模式。毕竟这是一种内化的行为模式。
